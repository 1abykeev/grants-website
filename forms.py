...
from wtforms import StringField, SubmitField, PasswordField, IntegerField, URLField, TextAreaField, DecimalField, BooleanField
...
class UniversityForm(FlaskForm):
    ...
    uni_logo = URLField("Logo PNG Link", validators=[Optional()])
    uni_picture = URLField("University Picture Link", validators=[Optional()])
    uni_desc = TextAreaField("Description", validators=[DataRequired()])
    ...
    prep_school = BooleanField("Has Prep School", validators=[Optional()])
    ...
    application_fee = DecimalField("Application Fee", validators=[Optional()])
    tuition_fee = DecimalField("Tuition Fee", validators=[Optional()])
    ...
    scholarship_available = BooleanField("Scholarship Available", validators=[Optional()])