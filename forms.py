...
class AddUniversityForm(FlaskForm):
    ...
    uni_official_page_link = StringField("Link to Official Webpage of University", validators=[Optional()])
    ...
    study_programs_link = StringField("Link to All Study Programs", validators=[Optional()])
    ...
    tuition_fee = StringField("Tuition Fee", validators=[Optional()])  # Changed to StringField
    tuition_fee_link = StringField("Link to Tuition Fees", validators=[Optional()])
